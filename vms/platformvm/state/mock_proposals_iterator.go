...
//
//	mockgen -package=state -destination=vms/platformvm/state/mock_proposals_iterator.go github.com/ava-labs/avalanchego/vms/platformvm/state ProposalsIterator
//
