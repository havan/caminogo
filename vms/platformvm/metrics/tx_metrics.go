...
type txMetrics struct {
	...
	numSendCommandTx prometheus.Counter
}
...
func newTxMetrics(
	...
	m := &txMetrics{
		...
		numSendCommandTx:                 newTxMetric(namespace, "send_command", registerer, &errs),
	}
	return m, errs.Err
}
...
func (m *txMetrics) SendCommandTx(*txs.SendCommandTx) error {
	m.numSendCommandTx.Inc()
	return nil
}
